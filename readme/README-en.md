...
|-|-|-|
| `/e <Angex>` | Auto-fish with custom parameters | [Angex Syntax](https://github.com/BlackCleaverLoli/MissFisher/wiki/Learn-Angex) (Chinese-only) |
`/e mfBigFish`<br>`/e mfLegends`|Start with specified Big Fish type<br> (case-insensitive)|
`/e mfCosmic`|Auto-fish based on active Cosmic Exploration task requirements<br>(case-insensitive)|
