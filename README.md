...
# 快速上手
> 写于国服 `6.58` 国际服 `7.05`  
> 空天姬 MissFisher `v1.5.3` `Snapshot 24w37b`

- **必须已安装并正确配置了空天姬所需的环境**

## 如何使用空天姬钓鱼？
首先需要你已经进行了相关配置，请继续，如果没有，请

空天姬的自动钓鱼功能必须通过将 [空天姬预设](https://github.com/BlackCleaverLoli/MissFisher/wiki/Learn-Presets) 发送到游戏内的默语频道来启动。

## 非出海垂钓

对于非出海垂钓，你有两种方法来使用空天姬自动钓鱼：
...
编写一条 [空天姬预设](https://github.com/BlackCleaverLoli/MissFisher/wiki/Learn-Presets)，将它发送到游戏内的默语频道，空天姬将立刻按照预设中包含的钓法开始自动钓鱼。

**使用空天姬内置预设**
2. 使用空天姬内置预设，输入 `/e 空天姬预设 <鱼名>`
