# 空天姬 MissFisher
**[安装指南](#安装指南) | [常见问题](#常见问题) | [2 分钟快速上手](#快速上手) | [所有命令](#命令)**
## 简介
...
## 致谢
**感谢 [@MnFeN](https://github.com/MnFeN/) [@Fragile](https://github.com/zfxsquare) [@欧尼棒棒](https://github.com/ONBBss/) 在 空天姬 MissFisher 开发时给予的大力支持与帮助！**
## 反馈
...
* 鲶鱼精邮差 [PostNamazu](https://github.com/Natsukage/PostNamazu/releases) `v1.3.3.1+`
* OverlayPlugin
* 可选的：抹茶 Matcha（仅国服）
### Dalamud 插件：
...
## 注意事项
- 钓饵不足时角色将停止收杆，此时 空天姬 MissFisher 不会发出任何提示，因此请保证携带了足够的钓饵！

- 当使用其他插件修改游戏内的本地天气，将影响 空天姬 MissFisher 的天气相关功能。
