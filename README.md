...
MissFisher 的航线预报由 2 行为 1 组：  
```  
11-02 02:00　「索蒂斯（火萤）」「依拉丝莫龙（重铁板钩）」　梅尔托尔海峡南(昏)》加拉迪翁湾(夜)》梅尔托尔海峡北(日)　04  
　　　　　　　「四海大宝贝¹」「塔尼瓦（青花鱼块）」　　　　 妖歌海海面(日)》黄金港近海(昏)》无二江下游(夜)  
```  
- 从左到右：  
开始登记时间丨航线标识丨海域与时间带丨在 MissFisher 的内部序号  
- 每组中：  
第 1 行是近海航线，第 2 行是远海航线，分别对应登记出海垂钓，选择航线时的第 1 项和第 2 项。  
...
标识|类型|说明  
-|-|-  
「挑战高分」|渔分|渔分上限较高，也适合获取「海王」称号&成就<br>全自动下少数情况能获得 3~4 万分的高分。  
「深洋之劫」|远洋<br>渔分|适合获取「深洋之劫」称号&成就的远洋航线  
「世界级钓手」|渔分|分数下限较高<br>适合获取「世界级钓手」称号&成就的航线  
「盾齿龙」<br>「海洋蟾蜍（潮虫）」<br>「依拉丝莫龙（重铁板钩）」<br>「哈弗古法（乌贼丝）」<br>「珊瑚蝠鲼（小虾肉笼）」<br>「索蒂斯（火萤）」<br>「石骨鱼（沟鼠尾巴）」|近海<br>蓝鱼|圆括号中是需要额外携带的钓饵  
「琉璃龙」<br>「狱之蟹（乌贼丝）」<br>「塔尼瓦（青花鱼块）」<br>「梅泉宝龟（石蝇幼虫）」|远洋<br>蓝鱼|圆括号中是需要额外携带的钓饵  
「水母狂魔¹」<br>「横路不通¹」<br>「只有我最鳐摆²」<br>「捕鲨人¹」<br>「龙马惊神¹」<br>「只有我最鳐摆¹」<br>「气鲀四海¹」<br>「八爪旅人¹」|近海<br>数量<br>成就|角标 `¹` `²`：<br>表示需求为该标识时应使用的成就模式<br>`¹` = 成就1<br>`²` = 成就2  
「大虾可重新来过²」<br>「大虾可重新来过¹」<br>「四海大宝贝¹」<br>「鱿型中队精英¹」|远洋<br>数量<br>成就|角标 `¹` `²`：<br>表示需求为该标识时应使用的成就模式<br>`¹` = 成就1<br>`²` = 成就2  
