# 更新日志
---
# Snapshot 24w37c　2024-09-15
> 10 个 Snapshot 的累积更新内容。  
>  
> 支持部分【金曦之遗辉】的技能与特性；新增【优先竿型】参数与【阶段】参数；追加断杆日志适配；优化海钓。  

## 功能更新
## 金曦之遗辉
> 我们终于迎来了久违的捕鱼人技能改动，此次技改为捕鱼人新增了许多令人激动的新技能和新特性，但对游戏性与游玩体验来说，那些新技能与新特性带来的可能并不是易用性与游戏性上的提升……
- 适配 “收杆” 的日志行事件。
...
- 现在预览预设时也将提示 “未经审核” 和 “低效预设” 。

- “低效预设” 提示现在只要求注释包含 “低效预设” 而不再要求写上某符号。
- 现在预览将提供简要的信息。
- 优化预览时发送的播报格式。
- 现在内置预设的日期信息更清晰了。
