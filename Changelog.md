# 更新日志
---
# Snapshot 24w40a　2024-09-30
> 优化功能，修复个别问题。

## BUG 修复及品质级改动
### 品质级改动
**自动钓鱼**
- 现在引诱动作更加频繁，动作间隔：333 ms → 200 ms

- 现在携带专一垂钓时不再尝试引诱。
- 为提钩信息等播报添加了引诱相关的信息。
- 为提钩信息等播报添加了专一垂钓相关的信息。
- 现在鱼咬饵而使用歇竿来不提起鱼时，提钩信息将播报为歇竿。

**海钓模式**
- 现在启动提醒不再连续播报。

**换饵**
- 在竿时活跃时将不转发换饵指令以减少由第三方换饵插件引起的错误报告刷屏。
- 当收到第三方换饵插件发送的无钓饵错误报告时将报错并终止自动钓鱼。
...
- **[相关 Wiki 条目](https://github.com/BlackCleaverLoli/MissFisher/wiki/Learn-Presets#17-%E5%BC%95%E8%AF%B1)** 。
